        ...
        const demoJobs = [
            {
                ...
                description: 'We\'re looking for an experienced developer with React expertise to join our growing team. The ideal candidate will have 5+ years of experience in web development and a strong portfolio of projects.',
            ...
            },
            {
                ...
                description: 'Join our design team to create beautiful and functional user interfaces for our products. You\'ll work closely with developers and product managers to create intuitive user experiences.',
            ...
            },
            {
                ...
                description: 'Seeking an experienced PM to lead our software development projects and coordinate teams. You\'ll be responsible for planning, execution, and delivery of projects on time and within budget.',
            ...
            try {
                ...
                if (contentType && contentType.indexOf('application/json') === -1) {
                    ...
                    if (text.startsWith('<!DOCTYPE') || text.startsWith('<html')) {
                        throw new Error(`Server returned HTML instead of JSON. Check that ${API_BASE_URL}${url} is a valid API endpoint.`);
                    } else {
        ...
        // Load jobs from API or show demo data
        async function loadJobs() {
            try {
                ...
                jobsLoading.style.display = 'none';
                showNotification('Using demo data. Real jobs will load when connection is restored.', true);
            }
        }
                    ...
                    <div class="card job-card h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                ${job.isDemo ? '<span class="badge bg-info">Demo</span>' : ''}
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            if (isConnected) {
                ...
                displayJobs(demoJobs);
                showNotification('Cannot connect to server. Showing demo data.', true);
            }
